...
export const metadata: Metadata = {
  ...
  description: 'Couvreur professionnel à Laval depuis plus de 25 ans. Spécialiste de la toiture à membrane blanche EPDM et TPO. Soumission gratuite, certifié APCHQ.',
};
  ...
  return (
    <main>
      <PageHeader
        ...
        lead="Votre spécialiste de toiture sur la Rive-Nord depuis 25 ans"
      />
      ...
      <section className="section section--light">
        <div className="container">
          ...
          <RevealOnScroll as="p" className="section__lead">
            ...
            Depuis plus de 25 ans, nous réalisons des projets d&apos;installation, de réfection et d&apos;entretien
