...
export const metadata: Metadata = {
  ...
  description: 'Compagnie de toiture à Laval et Montréal-Nord depuis plus de 25 ans. Spécialiste des membranes blanches EPDM et TPO pour toits plats. Membre APCHQ.',
  openGraph: {
    type: 'website',
    locale: 'fr_CA',
